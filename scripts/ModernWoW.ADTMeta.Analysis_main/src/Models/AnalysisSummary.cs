...
namespace ModernWoWTools.ADTMeta.Analysis.Models
{
    ...
    public class AnalysisSummary
    {
        ...
        /// <summary>
        /// Gets or sets the number of repaired paths.
        /// </summary>
        public int RepairedPaths { get; set; }
        ...
        /// <summary>
        /// Gets or sets the map of repaired paths.
        /// </summary>
        public Dictionary<string, string> RepairedPathMap { get; set; } = new Dictionary<string, string>();
