...
def main():
    ...
    parser.add_argument("--depth", type=int, default=10, help="Depth of the 3D model (default: 10)")
    ...
    for image_file in tqdm(image_files, desc='Processing Tiles'):
        ...
        while current_scale <= args.max_scale:
            ...
            build_3d_model(mesh_vertices, mesh_faces, output_file, args.export_format)
    ...
    # Merge models
    merge_models(args.output_dir, os.path.join(args.output_dir, "merged_model"), args.export_format)
