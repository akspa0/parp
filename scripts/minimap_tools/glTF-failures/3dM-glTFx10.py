...
def generate_mesh(points, debug=False):
    ...
    normals = o3d.geometry.estimate_normals(pcd, search_param=search_param, device=o3d.core.Device("CPU:0"))
    pcd.normals = normals
    ...
    mesh.filter_smooth_taubin(number_of_iterations=10, lambda_param=0.5, mu_param=-0.53)
