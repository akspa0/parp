    ...
    try:
        ...
        for (file_name,) in files:
            ...
            for chunk_id, chunk_data in chunks:
                ...
                # Check for organized data structure
                if 'terrain' in data or 'metadata' in data or 'textures' in data or 'others' in data:
                    for category, chunks in data.items():
                        for sub_chunk_id, sub_chunk_data in chunks.items():
                            initial_analysis.append({
                                "id": f"{category}_{sub_chunk_id}",
                                "data": sub_chunk_data
                            })
                else:
                    initial_analysis.append({
